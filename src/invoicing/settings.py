...
SECRET_KEY = 'olz07%#euv54=)sf5!-tzc4e+&)uxw5g+!zahtjf!(--sg7i+x'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

# ALLOWED_HOSTS = [13.211.97.129]
# CELERY STUFF
...
STATIC_ROOT =  os.path.join(os.path.dirname(BASE_DIR), "cdn_static", "static_root")
